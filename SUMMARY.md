...
* [✈️ Activation Function vs Vanishing Gradient](activation-function-vs-vanishing-gradient.md)
* [✈️ Equations](equations.md)
* [✈️ Code - Classifier](code-classifier.md)
* [✈️ Evaluation Metrics, Loss Function](evaluation-metrics-loss-function.md)
...
* [✈️ Implementing Word Embedding with Keras Tensorflow](implementing-word-embedding-with-keras-tensorflow.md)
...
* [✈️ Attention - Introduction](attention-introduction.md)
* [✈️ Key Points](key-points.md)
* [✈️ Self Attention](self-attention.md)
* [✈️ Attention is all you need - Research Paper](attention-is-all-you-need-research-paper.md)
* [✈️ Attention is all you need](attention-is-all-you-need.md)
...
* [🟢 Usage of scale and shift](usage-of-scale-and-shift.md)
* [✈️ Layer Normalization Example](layer-normalization-example.md)
...
* [💀 Compute Mask](compute-mask.md)
* [🟢 Encoder Decoder Multi Head Attention](encoder-decoder-multi-head-attention.md)
* [✈️ Transformers - Blog](transformers-blog.md)
* [🟢 Final Decoder Linear and Softmax Layer](final-decoder-linear-and-softmax-layer.md)
* [🟢 How is a GPT Trained](how-is-a-gpt-trained.md)
* [---------- 100 ----------](100.md)
* [🟢 How is BERT Trained](how-is-bert-trained.md)
* [🟢 How is BART Trained](how-is-bart-trained.md)
* [🟡 Importance of Masking](importance-of-masking.md)
